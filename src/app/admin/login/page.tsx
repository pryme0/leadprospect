            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  tabIndex={-1}
                  className="absolute inset-y-0 right-0 px-3 flex items-center text-white/40 hover:text-white/80 transition-colors focus:outline-none focus-visible:text-[#0BAAEF]"
                >
                  {showPassword ? (
