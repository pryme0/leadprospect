...
export async function POST(req: NextRequest) {
  ...
  const provision = await provisionAndCrawl({
    ...
    socialKeywords: { tiktok: analysis.keywords_tiktok, instagram: analysis.keywords_instagram, threads: analysis.keywords_threads, x: analysis.keywords_x },
...
export async function PATCH(req: NextRequest) {
  ...
  const provision = await provisionAndCrawl({
    ...
    companyName: profile.company_name,
    keywords,
    socialKeywords: { tiktok: updated.keywords_tiktok, instagram: updated.keywords_instagram, threads: updated.keywords_threads, x: updated.keywords_x },
